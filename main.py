...
df_PlayTimeGenre = pd.read_parquet('datasets/datasets/PlayTimeGenre.parquet')
...
df_UserForGenre = pd.read_parquet('datasets/datasets/UserForGenre_total.parquet')
...
df_UsersRecommend = pd.read_parquet('datasets/datasets/UsersRecommend.parquet')
...
df_UsersNotRecommend = pd.read_parquet('datasets/datasets/UsersNotRecommend.parquet')
...
df_SentimentRecommend = pd.read_parquet('datasets/datasets/SentimentRecommend.parquet')
